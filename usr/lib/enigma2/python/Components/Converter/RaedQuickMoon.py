...
from Components.FhromaMoonCalculations import phase, get_julian_datetime, phase_string
from Components.Language import language
#from decimal import Decimal as dec
import math, datetime

DBG = False
if DBG: from Components.FhromaComponents import j00zekDEBUG
...
class RaedQuickMoon(Converter, object):
    PHASE = 0
    ICON = 1
    LUMINATION = 2
    LUMINATION3 = 3
