...
if [ -f /var/lib/dpkg/status ]; then
   ...
   echo ""
   #cd /tmp
   #wget https://github.com/0x733/RaedQuickSignal/archive/refs/heads/main.tar.gz
   #tar -xzf main.tar.gz
   #cp -r 'RaedQuickSignal-main/usr' '/'
   #cp -r 'RaedQuickSignal-main/tmp/RaedQuickSignal' '/tmp'
   #wget https://github.com/0x733/RaedQuickSignal/raw/main/RaedQuickServName2-dreamos.tar.gz
